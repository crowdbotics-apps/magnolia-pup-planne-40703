...
## Project Structure
    ...
    ├── magnolia_pup_planne_40703  # Django project configurations
...
1. Clone this repo and `cd magnolia_pup_planne_40703`
...
2. Clone this repo and `cd magnolia_pup_planne_40703`
